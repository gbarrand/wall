...
static int SoPlotterRegion_sDoCounter = 0;
void SoPlotterRegion::doAction(SoAction* aAction){
  SO_ALTERNATEREP_DO_ACTION(aAction)

  if(verbose.getValue()==TRUE) {
    SoDebugError::postInfo("SoPlotterRegion::doAction","%lu (%d).",(unsigned long)this,SoPlotterRegion_sDoCounter++);
  }
