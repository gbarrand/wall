...
/*G.Barrand : */
#define deflate                ourex_cfitsio_deflate
#define deflate_fast           ourex_cfitsio_deflate_fast
#define inflate                ourex_cfitsio_inflate
#define inflate_codes          ourex_cfitsio_inflate_codes
#define inflate_stored         ourex_cfitsio_inflate_stored
#define inflate_fixed          ourex_cfitsio_inflate_fixed
#define inflate_dynamic        ourex_cfitsio_inflate_dynamic
#define inflate_fast           ourex_cfitsio_inflate_fast
