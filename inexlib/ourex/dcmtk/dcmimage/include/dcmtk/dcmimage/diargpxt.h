  ...
  : public DiColorPixelTemplate<T3>
{
 ...
 private:
    ...
    {                                             // not very much optimized, but no one really uses ARGB !!
      if (DiColorPixelTemplate<T3>::Init(pixel)) //G.Barrand
        {
            ...
            {
/*
                G_Barrand_register const T1 *a = pixel;                                   // points to alpha plane
                const T1 *rgb[3];
...
*/
                ...
                /*G.Barrand register*/ const T1 *a = pixel;                                   // points to alpha plane
                const T1 *rgb[3];
 ...
 * *** empty log message ***
 *
 * Revision 1.1.1.1  2013/04/16 19:23:55  barrand
 *
 *
