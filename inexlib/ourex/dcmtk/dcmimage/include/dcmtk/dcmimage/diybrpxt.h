      ...
      if (DiColorPixelTemplate<T2>::Init(pixel)) //G.Barrand
        {
            ...
            if (rgb)    /* convert to RGB model */
            {
                ...
                if (bits == 8 && !rep.isSigned())          // only for unsigned 8 bit
                {
                    ...
                    /*G.Barrand register*/ Sint32 sr;
                    /*G.Barrand register*/ Sint32 sg;
                    /*G.Barrand register*/ Sint32 sb;
                    if (this->PlanarConfiguration)
                    {
/*
                        G_Barrand_register const T1 *y = pixel;
                        G_Barrand_register const T1 *cb = y + this->InputCount;
                        G_Barrand_register const T1 *cr = cb + this->InputCount;
...
*/
                        /*G.Barrand register*/ const T1 *y = pixel;
                        /*G.Barrand register*/ const T1 *cb = y + planeSize;
                        /*G.Barrand register*/ const T1 *cr = cb + planeSize;
                    ...
                    else
                    {
                        ...
                        /*G.Barrand register*/ T1 y;
                        /*G.Barrand register*/ T1 cb;
                        /*G.Barrand register*/ T1 cr;
...
*/
                    ...
                    {
                        /*G.Barrand register*/ const T1 *p = pixel;
                        /*G.Barrand register*/ T2 y;
                        /*G.Barrand register*/ T2 cb;
                        /*G.Barrand register*/ T2 cr;
                        /*G.Barrand register*/ unsigned long i;
                        for (i = count; i != 0; --i)
                        {
...
*/
                    /*G.Barrand register*/ unsigned long l;
                    /*G.Barrand register*/ unsigned long i = 0;
                    while (i < count)
                    {
