    ...
    public DiPixelRepresentationTemplate<T>
{
 ...
 public:
                        ...
                        const int planar) const
    {
        ...
        {
            /*G.Barrand register*/ T *q = OFstatic_cast(T *, data);
            /*G.Barrand register*/ int j;
            /*G.Barrand register*/ unsigned long k;
            /*G.Barrand register*/ unsigned long offset = 0;
            if (planar)
            {
                /* for all frames ... */
                for (k = 0; k < frames; ++k)
                            ...
                            const int padding) const
    {
        ...
        if ((Data[0] != NULL) && (Data[1] != NULL) && (Data[2] != NULL) && (toBits <= 8))
        {
            ...
            /*G.Barrand register*/ const T *r = Data[0] + start;
            /*G.Barrand register*/ const T *g = Data[1] + start;
            /*G.Barrand register*/ const T *b = Data[2] + start;
