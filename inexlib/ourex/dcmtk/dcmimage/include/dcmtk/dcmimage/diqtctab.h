...
public:
  ...
  {
	int result = -1;
    /*G.Barrand register*/ int r2, g2, b2;
    /*G.Barrand register*/ long newdist;
    /*G.Barrand register*/ int r1 = OFstatic_cast(int, px.getRed());
    /*G.Barrand register*/ int g1 = OFstatic_cast(int, px.getGreen());
    /*G.Barrand register*/ int b1 = OFstatic_cast(int, px.getBlue());
    /*G.Barrand register*/ long dist = 2000000000;
