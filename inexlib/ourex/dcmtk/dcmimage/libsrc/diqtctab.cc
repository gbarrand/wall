  ...
  DcmRepresentativeColorType repType)
{
  ...
  /*G.Barrand register*/ int i;
  /*G.Barrand register*/ unsigned int bi;
  ...
  {
      /*G.Barrand register*/ int indx, clrs;
      unsigned long sm;
      /*G.Barrand register*/ int minr, maxr, ming, maxg, minb, maxb, v;
  ...
  */
  if (repType == DcmRepresentativeColorType_centerOfBox)
  {
      for ( bi = 0; bi < boxes; ++bi )
      {
          /*G.Barrand register*/ int indx = bv[bi].ind;
          /*G.Barrand register*/ int clrs = bv[bi].colors;
          /*G.Barrand register*/ int minr, maxr, ming, maxg, minb, maxb, v;
  ...
  else if (repType == DcmRepresentativeColorType_default)
  {
      for ( bi = 0; bi < boxes; ++bi )
      {
          /*G.Barrand register*/ int indx = bv[bi].ind;
          /*G.Barrand register*/ int clrs = bv[bi].colors;
          /*G.Barrand register*/ long r = 0, g = 0, b = 0;
  ...
  else // DcmRepresentativeColorType_averagePixels
  {
      for ( bi = 0; bi < boxes; ++bi )
      {
          /*G.Barrand register*/ int indx = bv[bi].ind;
          /*G.Barrand register*/ int clrs = bv[bi].colors;
          /*G.Barrand register*/ unsigned long r = 0, g = 0, b = 0, sumVal = 0;
