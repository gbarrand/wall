    ...
    Data(data)
{
    if (temp != NULL)
    {
        ...
        /*G.Barrand register*/ Uint16 *q = temp;
        /*G.Barrand register*/ const Uint16 mask = 1 << bit;
        ...
        if (bits == 1)
        {
            ...
            if (data != NULL)
            {
                if ((fore & mask) != (back & mask))
                {
                    ...
                    /*G.Barrand register*/ Uint16 x;
                    /*G.Barrand register*/ Uint16 y;
                    /*G.Barrand register*/ Uint8 value = 0;
                    /*G.Barrand register*/ Uint8 *q = data;
                    /*G.Barrand register*/ int bit = 0;
                                                 ...
                                                 unsigned long &frames)
{
    ...
    if (Valid && (count > 0))
    {
        ...
        if (buffer != NULL)
        {
            ...
            /*G.Barrand register*/ Uint16 y;
            /*G.Barrand register*/ Uint8 value = 0;
            /*G.Barrand register*/ Uint8 *q = buffer;
            /*G.Barrand register*/ int bit = 0;
            for (unsigned long f = 0; f < NumberOfFrames; ++f)
            {
