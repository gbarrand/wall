                         ...
                         const OFBool printMode)
{
        ...
        (gsdf_cnt > 0) && (jnd_min < jnd_max))
    {
        ...
        if (jidx != NULL)
        {
            ...
            /*G.Barrand register*/ double *s = jidx;
            /*G.Barrand register*/ double value = jnd_min;                            // first value is fixed !
                ...
                if (gsdf != NULL)
                {
                        ...
                        OFstatic_cast(unsigned int, gin_ctn)))
                    {
                        ...
                        if (DataBuffer != NULL)
                        {
                            ...
                            /*G.Barrand register*/ unsigned long j = 0;
                            /* check whether to apply the inverse transformation */
                            if (inverse)
                            {
                                /*G.Barrand register*/ double v;
                                ...
                                j = ddl_min;
                                /*G.Barrand register*/ const double *r = gsdf;
