...
int DiGSDFunction::calculateGSDF()
{
    ...
    if (GSDFValue != NULL)
    {
        ...
        /*G.Barrand register*/ unsigned int i;
        /*G.Barrand register*/ double ln;
        /*G.Barrand register*/ double ln2;
        /*G.Barrand register*/ double ln3;
        /*G.Barrand register*/ double ln4;
...
int DiGSDFunction::calculateGSDFSpline()
{
    ...
    if ((GSDFValue != NULL) && (GSDFCount > 0))
    {
        ...
        {
            /*G.Barrand register*/ unsigned int i;
            /*G.Barrand register*/ unsigned int *p = jidx;
...
double DiGSDFunction::getJNDIndex(const double lum)
{
    if (lum > 0.0)
    {
        ...
        double lg10[8];
        lg10[0] = log10(lum);
        /*G.Barrand register*/ unsigned int j;
