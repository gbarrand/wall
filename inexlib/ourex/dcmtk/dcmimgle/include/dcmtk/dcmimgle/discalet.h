...
static inline void setScaleValues(Uint16 data[],
                                  ...
                                  const Uint16 max)
{
    /*G.Barrand register*/ Uint16 remainder = max % min;
    ...
    /*G.Barrand register*/ Uint16 i;
    /*G.Barrand register*/ double c = count;
    for (i = 0; i < min; ++i)
    {
  ...
  : public DiTransTemplate<T>
{
 ...
 private:
                   ...
                   T *dest[])
    {
        ...
        /*G.Barrand register*/ Uint16 x;
        /*G.Barrand register*/ Uint16 y;
        /*G.Barrand register*/ const T *p;
        /*G.Barrand register*/ T *q;
                        ...
                        T *dest[])
    {
        ...
        /*G.Barrand register*/ Uint16 x;
        /*G.Barrand register*/ Uint16 y;
        /*G.Barrand register*/ Uint16 dx;
        /*G.Barrand register*/ Uint16 dy;
        /*G.Barrand register*/ const T *p;
        /*G.Barrand register*/ T *q;
        /*G.Barrand register*/ T value;
        for (int j = 0; j < this->Planes; ++j)
        {
                          ...
                          T *dest[])
    {
        ...
        if ((xtemp == NULL) || (xvalue == NULL))
        {
            ...
            DiTransTemplate<T>::clearPixel(dest);
        } else {
            for (int j = 0; j < this->Planes; ++j)
            {
                fp = src[j];
                ...
                for (unsigned long f = this->Frames; f != 0; --f)
                {
                    ...
                    /*G.Barrand register*/ unsigned long yfill = SCALE_FACTOR;
                    /*G.Barrand register*/ unsigned long yleft = syscale;
                    /*G.Barrand register*/ int yneed = 1;
                    int ysrc = 0;
                    for (y = 0; y < this->Dest_Y; ++y)
                    {
                        ...
                        else
                        {
                            ...
                            /*G.Barrand register*/ signed long v;
                        ...
                        {
                            /*G.Barrand register*/ signed long v = HALFSCALE_FACTOR;
                            /*G.Barrand register*/ unsigned long xfill = SCALE_FACTOR;
                            /*G.Barrand register*/ unsigned long xleft;
                            /*G.Barrand register*/ int xneed = 0;
                            q = sq;
                     ...
                     T *dest[])
    {
        ...
        /*G.Barrand register*/ int xi;
        /*G.Barrand register*/ int yi;
        /*G.Barrand register*/ Uint16 x;
        /*G.Barrand register*/ Uint16 y;
        /*G.Barrand register*/ const T *p;
        /*G.Barrand register*/ T *q;
    ...
    */
                       ...
                       T *dest[])
    {
        ...
        /*G.Barrand register*/ Uint16 x;
        /*G.Barrand register*/ Uint16 y;
        /*G.Barrand register*/ T *pD;
        /*G.Barrand register*/ T *pCurrTemp;
        /*G.Barrand register*/ const T *pCurrSrc;
        Uint16 nSrcIndex;
        double dOff;
        T *pT;
        const T *pS;
