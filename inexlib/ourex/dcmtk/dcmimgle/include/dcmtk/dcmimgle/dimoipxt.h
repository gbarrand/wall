      ...
      : DiMonoPixelTemplate<T3>(pixel, modality)
    {
        ...
        if ((pixel != NULL) && (this->Count > 0))
        {
            ...
            else if ((this->Modality != NULL) && this->Modality->hasRescaling())
            {
                ...
                DiMonoPixelTemplate<T3>::determineMinMax(OFstatic_cast(T3, this->Modality->getMinValue()), OFstatic_cast(T3, this->Modality->getMaxValue()));
            } else {
        ...
        if ((pixel != NULL) && (this->Modality != NULL))
        {
            ...
            if (mlut != NULL)
            {
                ...
                if (this->Data != NULL)
                {
                    ...
                    /*G.Barrand register*/ const T1 *p = pixel + input->getPixelStart();
                    /*G.Barrand register*/ T3 *q = this->Data;
