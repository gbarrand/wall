    ...
    public DiPixelRepresentationTemplate<T>
{
 ...
 public:
                             ...
                             double &voiWidth)
    {
        ...
        {
            /*G.Barrand register*/ T *p = Data + (columns * rows * frame) + (top_pos * columns) + left_pos;
            ...
            /*G.Barrand register*/ unsigned long x;
            /*G.Barrand register*/ unsigned long y;
            /*G.Barrand register*/ T value = 0;
            /*G.Barrand register*/ T min = *p;                    // get first pixel as initial value for min ...
            /*G.Barrand register*/ T max = min;                   // ... and max
        ...
        if (Data != NULL)
        {
            if (mode & 0x1)
            {
                if ((minvalue == 0) && (maxvalue == 0))
                {
                    ...
                    /*G.Barrand register*/ T *p = Data;
                    /*G.Barrand register*/ T value = *p;
                    /*G.Barrand register*/ unsigned long i;
                    minvalue = value;
                    maxvalue = value;
            ...
            if (mode & 0x2)
            {
                ...
                /*G.Barrand register*/ int firstmin = 1;
                /*G.Barrand register*/ int firstmax = 1;
                /*G.Barrand register*/ unsigned long i;
